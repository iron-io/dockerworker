...
### 1. Vendor dependencies (if you have any dependencies defined in mix.exs):
...
Let's package it up inside a Docker image and upload it to a Docker Registry. Copy the [Dockerfile](https://github.com/iron-io/dockerworker/blob/master/elixir/Dockerfile) from this repository
